...
- 🔄 **Refresh токены**: Обновление access токенов через refresh
...
3. **Refresh токены**: Нет endpoint для обновления access токенов
4. **Logout**: Нет endpoint для выхода из системы
